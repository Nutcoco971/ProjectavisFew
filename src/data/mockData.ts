...
export const mockContents: Content[] = [
  {
    id: 'a9ceb6ff-1c4b-4b19-8095-9ca99339ec25', 
    title: 'Film Test Ultime pour Avis V2',    
    type: 'film',                             
    year: 2025,                               
    genre: ['Action', 'Aventure', 'Debug'],   
    imageUrl: 'https://via.placeholder.com/300x450?text=Cover+Image+Test', 
    creator: 'Le Développeur Précis',
    description: 'Description complète pour le test avec le bon nom de colonne image.',
    rating: 4.8 
  },
  {
    id: '1',
